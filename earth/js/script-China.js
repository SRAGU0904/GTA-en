$(() => {
  ...
  var projection = d3.geoOrthographic()
    ...
    //创建转换类，将d3绘制地图中使用的欧拉角转化为四元数以使旋转更为平滑
...
function changeto(l,roindex){
  ...
  const country_list=[
    ...
    ['Costa_Rica', 'Switzerland', 'Netherlands', 'United_States', 'Ireland', 'Venezuela', 'Cambodia', 'Poland', 'Turkey', 'Philippines', 'Dominican_Republic', 'Lebanon', 'Spain', 'Australia', 'South_Yemen', 'Ethiopia', 'Zambia', 'Israel', 'Sweden', 'Jordan', 'Bolivia', 'Uruguay', 'Brazil', 'Greece', 'Argentina', 'Italy', 'Guatemala', 'Egypt', 'Germany', 'United_Kingdom', 'Iran'],
    ...
    ['Costa_Rica', 'Chile', 'Switzerland', 'Netherlands', 'Colombia', 'United_States', 'Morocco', 'Myanmar', 'Ireland', 'Venezuela', 'Panama', 'Turkey', 'El_Salvador', 'Philippines', 'Japan', 'Austria', 'Lebanon', 'Pakistan', 'West_Bank_and_Gaza_Strip', 'Spain', 'Ethiopia', 'Jamaica', 'Mexico', 'France', 'Israel', 'Belgium', 'Jordan', 'Bolivia', 'Ecuador', 'Brazil', 'Algeria', 'Greece', 'Kenya', 'India', 'Bahamas', 'Namibia', 'Barbados', 'Argentina', 'Syria', 'Trinidad_and_Tobago', 'Portugal', 'Italy', 'Guatemala', 'Iraq', 'Nigeria', 'South_Africa', 'Germany', 'United_Kingdom', 'Kuwait', 'Iran', 'Paraguay'],
  ...
  const rotatelist=[
    ...
    [69,34,0],
    //1989
    [-75.02,-9.19,0],[116.20,39.56,0],[-75.02,-9.19,0],
    //1992
    ...
    [44,43,0],
    //2005
    [44,33,0],[44,33,0],[44,33,0],
    //2008
    [116.20,39.56,0],[116.20,39.56,0],[116.20,39.56,0],
    //2011
    [36,43,0],
    //2012
    [69.35,30.38,0],
    //2013
    [116.20,39.56,0],[116.20,39.56,0],
    //2015
    [44,33,0],[44,33,0],[44,33,0],
    //2018
    [67.71,33.94,0],[67.71,33.94,0],[67.71,33.94,0],
    //2021
    [116.20,39.56,0]
  ]
